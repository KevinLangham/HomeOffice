...
public class CustomerController {
	...
	public Customer addCustomer(@RequestParam final String firstName, @RequestParam final String lastName,
			@RequestParam final String dateOfBirth, @RequestParam final String locOfBirth,
